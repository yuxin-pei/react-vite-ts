...
import { SizeType, ConfigContext } from "./config-provider";
...
const Space: React.FC<SpaceProps> = (props) => {
	...
	// console.log(horizontalSize, verticalSize, latestIndex, supportFlexGap);
	...
	return (
		<div className={cn} style={{ ...style, ...gapStyle }} {...otherProps}>
